...
pub static STR_CLIENT_MAC: &[u8] = b"ClientMAC";
pub static STR_HANDSHAKE_SECRET: &[u8] = b"HandshakeSecret";
pub static STR_SERVER_MAC: &[u8] = b"ServerMAC";
pub static STR_SESSION_KEY: &[u8] = b"SessionKey";
